...
volatile uint32_t ADC1_Reading[2] = {0, 0};		//ADC1_Reading[0] = PA0 direkt neben Bildschirm | ADC1_Reading[1] = PA1 näher am MCU
volatile uint32_t temp_data = 1;				//volatile ist dass der Compiler weiß dass der wert sich immer verändert
volatile uint32_t m_tim1_set_value;				// mosfet timer 1 set value
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, B1_Pin|B2_Pin|D6_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(D5_GPIO_Port, D5_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : B1_Pin B2_Pin D6_Pin */
  GPIO_InitStruct.Pin = B1_Pin|B2_Pin|D6_Pin;
